...
//                System.out.println(i);
    ...
    public static boolean validarVariablesAuxiliaresMC(int a, int d,int m){
     ...
     public static boolean esMultiploDeFactoresPrimos(int m,int a){
        ArrayList<Integer> vector=factoresPrimosImpares(m);
        int n=0;
    ...
    public static boolean esMultiploDe4(int n1){
    	if (n1%4==0)
    		return true;
    	else
    		return false;
